...
class MultiMaskTimeSeriesDataset(Dataset):
    def __init__(self, data, missing_rate,adj_ori,adj, missing_type='random', num_masks=5):
        """
    ...
    def __getitem__(self, idx):
        ...
        return self.data[day_idx], self.masks[day_idx, mask_idx] , self.adj_ori, self.adj
    ...
    def get_historical_data(self, idx, history_length):
        ...
        """
        day_idx = idx // self.num_masks
        return self.data[day_idx - history_length:day_idx] ,self.masks[day_idx - history_length:day_idx]
